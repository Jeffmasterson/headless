...
const logUserPrefsHaveBeenSaved = () => {
    console.log(styles.success(`Your preference has been saved to ${userConfig.path}`));
};
const logTelemetryAlreadyDisabled = () => {
    console.log(styles.warn(`Faust.js' telemetry collection is already disabled.`));
};
/**
...
export const handleTelemetrySubcommand = () => {
    ...
    switch (subcommand) {
        case 'enable': {
            ...
            logTelemetryStatus();
            console.log('Faust.js telemetry is completely anonymous. Thank you for participating!');
            logTelemetryDocsUrl();
            break;
        }
        case 'disable': {
