...
export type ReduxStoreConfig<State, Selectors, Actions extends Record<string, import("../../types").ActionCreator>> = import('../../types').ReduxStoreConfig<State, Actions, Selectors>;
